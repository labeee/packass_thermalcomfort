...
#input=c("input comfortvector")
#output=c("output comfortvector")

comfortvector=function (input,output){
      ...
      #--------Operative temperature formula - ASHRAE Standard 55 (2017) Appendix A-------#
